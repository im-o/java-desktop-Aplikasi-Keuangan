 ...
 * @author Ramayanti
 */
public class jurnalKhusus extends javax.swing.JInternalFrame {
//    String jenisAkun = "";
...
//        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jComboBoxPilih.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih -", "Kas/Tunai", "Utang" }));
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabelRef, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
...
//        System.out.println("Jenis akun saat ini : "+jenisAkun);
        ...
        try {
            ...
            String sqlQuery = "INSERT INTO "+jenisDB+" (id_j, tanggal_j, ket_j, jenis_pembayaran_j, ref_j, harga_j, jumlah_j, total_harga_j)"
            + "VALUES (NULL,?,?,?,?,?,?,?)";
            try {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            ...
            try {
                //hubungkan ke database
                connection = dbKonek.koneksiDB();
                String sqlQuery = "UPDATE "+jenisDB+" SET tanggal_j=?, ket_j=?, jenis_pembayaran_j=?, ref_j=?, harga_j=?, jumlah_j=?, total_harga_j=?"
                + "WHERE id_j=?";
                try {
                    PreparedStatement preStatement = (PreparedStatement) connection.prepareStatement(sqlQuery);
                    try {
...
//            jSpinnerTotal.setValue(Integer.valueOf(ttlAkun));
    ...
    private void jComboBoxPilih(){
        if (jComboBoxPilih.getSelectedItem().equals("Kas/Tunai")){
            txtRef.setText("101");
            jLabelRef.setText("Kas");
            jnsPembayaran = "Kas/Tunai";
        }
        else if(jComboBoxPilih.getSelectedItem().equals("Utang")){
            txtRef.setText("201");
